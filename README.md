...
3. Configure EmailJS credentials in `contact.js`
4. Add your CV/resume file and update download links
5. Replace images (`dp.jpg`, `FedxD.jpg`) with your own
6. Push to GitHub
...
### Content
Update information in respective HTML files:
...
### Contact Form
Configure EmailJS in `contact.js`:
- Update service ID
- Update template IDs
...
- **Email**: kazimabbasdev@gmail.com
- **Phone**: +92 332 2656 333
- **Location**: Karachi, Pakistan

## 📄 License

This portfolio is personal property. Feel free to use it as inspiration, but please don't copy it directly.

---

**Built with ❤️ by Kazim Abbas**
