            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="flex gap-3 mt-auto">
                  {/* View Details Button - Only show if project has detailed data */}
                  {hasProjectDetails(project.title) && (
                    <Link
                      to={`/projects/${project.title.replace(/\s+/g, '-').replace(/[()]/g, '')}`}
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-full font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover-glow"
                    >
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`${hasProjectDetails(project.title) ? '' : 'flex-1'} px-6 py-3 bg-gray-700 hover:bg-gray-600 rounded-full font-semibold flex items-center justify-center gap-2 transition-all duration-300`}
                  >
