        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-300">
              ...
              <code className="ml-2 px-2 py-1 bg-gray-800 rounded text-purple-400">
        ...
        >
          ...
          <div className="p-6 border-b border-gray-700">
            <div className="flex items-center gap-4 mb-3">
              <span className={`px-3 py-1 rounded-md font-mono text-sm border ${getMethodColor(endpoint.method)}`}>
                {endpoint.method}
              </span>
            ...
            {endpoint.authentication && (
              <span className="inline-block px-3 py-1 bg-orange-500/20 text-orange-400 text-sm rounded-md border border-orange-500">
              ...
              {Array.isArray(endpoint.requestBody) ? (
                <div className="space-y-3">
                  {endpoint.requestBody.map((field, fieldIdx) => (
                    <div key={fieldIdx} className="bg-gray-900 rounded-lg p-4 border-l-4 border-purple-500">
                      ...
                      <p className="text-gray-400 text-sm mt-2">{field.description}</p>
                      {field.example && (
                        <div className="mt-2">
                ...
                <div className="relative">
                  ...
                  <pre className="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                    <code className="text-sm text-gray-300">{endpoint.requestBody}</code>
                  </pre>
                </div>
              )}
            </div>
            ...
            <div className="p-6 border-b border-gray-700">
              ...
              <div className="space-y-4">
                {endpoint.responses.map((resp, respIdx) => (
                  <div key={respIdx} className="bg-gray-900 rounded-lg overflow-hidden border border-gray-700">
                    <div className={`px-4 py-2 ${resp.status >= 200 && resp.status < 300 ? 'bg-green-500/20' : 'bg-red-500/20'}`}>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-gray-300">{resp.description}</span>
                      </div>
                    </div>
                    <div className="relative">
                      <button
                      ...
                      <pre className="p-4 overflow-x-auto">
                        <code className="text-sm text-gray-300">{JSON.stringify(resp.example, null, 2)}</code>
                      </pre>
                    </div>
                  </div>
                ))}
          ...
          {endpoint.errorResponse && (
            <div className="p-6">
              ...
              <div className="relative">
                ...
                <pre className="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                  <code className="text-sm text-gray-300">{endpoint.errorResponse}</code>
                </pre>
              </div>
            </div>
          )}
          ...
          {endpoint.notes && Array.isArray(endpoint.notes) && endpoint.notes.length > 0 && (
            <div className="p-6 bg-blue-500/5 border-t border-gray-700">
              <h4 className="text-white font-semibold mb-3">📝 Notes</h4>
              <ul className="space-y-2">
                {endpoint.notes.map((note, noteIdx) => (
                  <li key={noteIdx} className="flex items-start gap-2 text-gray-300">
