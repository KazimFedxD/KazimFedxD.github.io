  ...
  if (inline) {
    return (
      <motion.div
        ...
        className="card-gradient p-6 rounded-2xl border-2 border-green-500/30"
      >
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-slate-400">Looking for remote Backend Development opportunities</p>
          </div>
          <Link to="/contact">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full font-semibold hover:shadow-lg hover:shadow-green-500/50 transition-all duration-300"
            >
              Let's Talk
            </motion.button>
          </Link>
