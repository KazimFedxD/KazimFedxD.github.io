...
export const tokens = {
  ...
  terminal:      "oklch(0.78 0.20 145)",
  terminal1:     "oklch(0.84 0.18 145)",
  terminal2:     "oklch(0.70 0.19 145)",
...
export const lightTokens = {
  ...
  ink3:      "oklch(0.52 0.012 145)",
  rule:      "oklch(0.86 0.012 90)",
  rule1:     "oklch(0.72 0.012 90)",
  terminal:      "oklch(0.48 0.16 145)",
  terminal1:     "oklch(0.52 0.18 145)",
  terminal2:     "oklch(0.42 0.15 145)",
